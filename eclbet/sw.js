...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20211129.09.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "clientName": "WEB",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20211129.09.00",
    "LATEST_ECATCHER_SERVICE_TRACKING_PARAMS": {
        "client.name": "WEB"
    }
});
window.ytcfg.obfuscatedData_ = [];
importScripts('https:\/\/www.youtube.com\/s\/desktop\/1b183e4b\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');

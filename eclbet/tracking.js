!function() {
        ...
        return p((function(i, o) {
            if (r(o, n))
                if (u(e[o]) && u(n[o]))
                    ...
                    t[o] = Array(c);
                    for (var s = 0; c > s; s++)
                        s in n[o] ? t[o][s] = n[o][s] : s in e[o] && (t[o][s] = e[o][s])
                } else
                    t[o] = n[o];
            else
                t[o] = e[o]
    ...
    var F = /[^:]+:\/\/[^(/|?)\s]+/
      ...
      , R = (RegExp("^[\0-]*(" + B("javascript") + "|" + B("data") + "):", "i"),
    /^((http(s)?:)?\/\/)/)
      , V = function(e) {
        return function(n, t) {
            if (0 === n) {
        ...
        return e.prototype.sendHandshake = function(n) {
            ...
            return new e.Promise((function(e, a) {
                i.parent.addEventListener("message", (function n(o) {
                    return !!Me(o, r) && ("handshake-reply" === o.data.postmate ? (clearInterval(t),
                    i.parent.removeEventListener("message", n, !1),
                    i.childOrigin = o.origin,
                    e(new je(i))) : a("Failed handshake"))
                }
                ), !1);
                var u = function() {
                    o++,
    ...
    function dn(e, n, t) {
        return function(i) {
            ...
            }(t.__unsafeProperties.group), f = l.desktopVisibility, p = l.mobileVisibility, h = [{
    ...
    function hn(e, n) {
        ...
        if (i) {
            ...
            e.call("storeMethod", ["requestUpdateUser", Ee(e.state), n])
    }
    function vn(e, n) {
    ...
    function Sn(e, n, t) {
        ...
        i.set_custom_variables = function(n) {
            an("LC_API.set_custom_variables", n),
            vn(e, pn(n))
        }
        ,
        ...
        i.open_chat_window = i.show_full_view = i.open_mobile_window = function() {
            an("LC_API.open_chat_window"),
            e.maximize()
        }
        ,
        i.minimize_chat_window = function() {
            an("LC_API.minimize_chat_window"),
            Tn(n) || e.minimize()
        }
        ,
        i.hide_eye_catcher = function() {
            an("LC_API.hide_eye_catcher"),
            e.call("hideEyeCatcher")
        }
        ,
        i.hide_chat_window = function() {
            an("LC_API.hide_chat_window"),
            Tn(n) || e.hide()
        }
        ,
        i.agents_are_available = function() {
            return an("LC_API.agents_are_available"),
            "online" === Oe(e.state, "availability")
        }
        ,
        i.chat_window_maximized = function() {
            return an("LC_API.chat_window_maximized"),
            gn(e.state, "maximized")
        }
        ,
        i.chat_window_minimized = function() {
            return an("LC_API.chat_window_minimized"),
            gn(e.state, "minimized")
        }
        ,
        i.chat_window_hidden = function() {
            return an("LC_API.chat_window_hidden"),
            gn(e.state, "hidden")
        }
        ,
        i.visitor_queued = function() {
            return an("LC_API.visitor_queued"),
            Ce(e.state, Pn).properties.queued
        }
        ,
        i.chat_running = function() {
            return an("LC_API.chat_running"),
            Ce(e.state, Pn).active
        }
        ,
        i.visitor_engaged = function() {
            return an("LC_API.visitor_engaged"),
            i.visitor_queued() || i.chat_running() || !!Ce(e.state, Pn).properties.fakeAgentMessageId
        }
        ,
        i.get_window_type = function() {
            return an("LC_API.get_window_type"),
            "embedded"
        }
        ,
        i.close_chat = function() {
            an("LC_API.close_chat"),
            e.call("storeMethod", ["requestUpdateChat", Pn, {
                active: !1
            }])
        }
        ,
    ...
    var Mn = {
      ...
      , jn = "liveChatChatId"
      , Nn = function(e) {
        var t, i = e.trackerId, r = e.variables;
        return n({}, c(String, void 0 === r ? {} : r), ((t = {})["__sales_tracker_" + i] = "1",
        t))
    }
      , qn = function(e) {
        var t = e.id;
    ...
    function Fn(e, t, i) {
        var r, o = De(), a = window.LiveChatWidget, u = function(e, n) {
            var t;
            return (t = {
                get: w,
                call: k,
        ...
        function v(e, n) {
            an("LiveChatWidget.on", "'" + e + "'", n),
            h("on", e, n)
        }
        function m(e, n) {
            an("LiveChatWidget.once", "'" + e + "'", n),
            h("once", e, n)
        }
        function _(n) {
            switch (n) {
        ...
        function w(e) {
            return an("LiveChatWidget.get", "'" + e + "'"),
            _(e)
        }
        function k(n, i) {
            switch (an.apply(void 0, ["LiveChatWidget.call", "'" + n + "'"].concat(i)),
            n) {
            case "hide":
            case "maximize":
            case "minimize":
      ...
      , mt = function(e, t, i) {
        ...
        if (r.enabled && !function(e, n) {
            ...
            var o, a, u = function(e) {
                ...
                var o, a = q("div", Je), s = st(t);
                P(((o = {
                    bottom: r.y + "px"
                })[s] = r.x + "px",
                o), a);
                var d, l = q("div", Xe);
                15 > r.x && "right" === s && P(((d = {})[s] = 10 - r.x + "px",
                d), l);
                l.innerHTML = "&times;";
                var f = q("div", Ye)
                  , p = n({}, $e, {
                ...
                lt(window.matchMedia) && window.matchMedia("(hover: none)").matches ? P({
                    display: "block"
    ...
    var kt = function(e) {
      ...
      , Lt = function(e) {
        ...
        K(t, i, r)), he(Q(e, "unbind")), Y((function(n) {
            e.emit("focus", n)
        }
        )))
    }
    ...
    function zt(e) {
        e.target !== window && e.target !== document && (Et || (xt = "keyboard"),
        Et = !1)
    }
    function St() {
        Et = !1
    }
    var Mt = (document.addEventListener("keydown", Ot, !0),
    ...
    "undefined" != typeof PointerEvent ? (document.addEventListener("pointerdown", Tt, !0),
    document.addEventListener("pointermove", Tt, !0),
    document.addEventListener("pointerup", Tt, !0)) : (document.addEventListener("mousedown", Tt, !0),
    ...
    function() {
        ...
        "undefined" != typeof PointerEvent ? (document.removeEventListener("pointerdown", Tt, !0),
        document.removeEventListener("pointermove", Tt, !0),
        document.removeEventListener("pointerup", Tt, !0)) : (document.removeEventListener("mousedown", Tt, !0),
    ...
    var Nt = {
      ...
      , Bt = function() {
        ...
        var r = function() {
            var e, i = b(t);
            return i ? (e = i,
            Wt() - e.startTime + e.duration) : Wt() - n
        };
        return {
            disconnect: function() {
                return i.disconnect()
            ...
            return {
                getLogs: function() {
                    return e.then((function(e) {
                        ...
                        ))).length ? null : n[0], i = Vt("lc_bridge_init"), r = Vt("lc_bridge_ready");
                        return c((function(e) {
    ...
    function $t(t, i) {
        ...
        return new e((function(e, i) {
            j().then((function(r) {
                var o, u = document.createElement("script"), d = s || v(Yt);
                Yt[d] = !0;
                var l = "__" + d;
                window[l] = function(n) {
                    delete Yt[d],
    ...
    var Kt, Qt, Zt, ei, ni = "__test_storage_support__", ti = "@@test", ii = function() {
        ...
        try {
            ...
            return n.setItem(ni, ti),
            n.getItem(ni) !== ti ? !1 : (n.removeItem(ni),
            !0)
        } catch (e) {
            return !1
        }
    ...
    function(e) {
        ...
        return {
            id: e.id,
            fields: !("id"in e.fields[0]) ? (t = e.fields,
        ...
        return $t(si("get_dynamic_configuration", t), {
            ...
            if (i.error)
                ...
                default:
                    ...
                    throw r.code = i.error.type.toUpperCase(),
                    r
                }
            if (!i.domain_allowed) {
                var o = Error("Current domain is not added to the allowlist.");
                throw o.code = "DOMAIN_NOT_ALLOWED",
                o
            }
            return {
                groupId: i.group_id,
        ...
        var n, t, i, r = e.allowVideoConferencing, o = e.allowClipboardWrite, a = [];
        if (e.allowAutoplay && !ht() && a.push("autoplay;"),
        r) {
            var u = {
                "display-capture *;": !g("Chrome", navigator.userAgent) || (i = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./),
            ...
            a = [].concat(a, ["microphone *;", "camera *;"], Object.keys((n = Boolean,
        ...
        return o && !ht() && a.push("clipboard-write *;"),
        a.join(" ")
    }, fi = pt(), pi = function(e) {
        ...
        var i, r = q("div", Ue), o = dt(e, fi), a = mi(t, e), u = hi(e);
        return P(n(((i = {
            width: u.width,
            height: u.height
        })[st(e, fi)] = o.x + "px",
        ...
        }, l = i.iframeAddress + "?" + c, f = new MutationObserver((function(e) {
        ...
        t.custom || vt(t.element, (function() {
        ...
        function(e, n, t) {
            Sn(e, n, t),
            "LiveChatWidget"in window && Fn(e, n, t)
        }(e, n, r),
        Xn(e, n),
        Z(En(e, (function() {
            return function(e) {
        ...
        return Array.isArray(n) && (t.properties = pn(n)),
        t
    };
    window.__lc_inited || (window.__lc_inited = !0,
    3 === [1].reduce((function(e, n) {
        return e + n
    }
    ), 2) ? function(t) {
    ...
    }((Qt = window.__lc,
    {
        ...
        requestedGroupId: (Zt = void 0 !== Qt.group ? Qt.group : Qt.skill,
